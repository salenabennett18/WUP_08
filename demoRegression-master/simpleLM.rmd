...
The best model was HEADLEN as seen by the adjusted R-square and the prediction of the length for the   three bears 5, 15 and 23 is 70.31, 51.94, 58.83.   
The actual lengths of the bears was   
`r bears$LENGTH[c(5, 15, 23)]`
  

The error in prediction for bear number 5 was about eight inches, for bear number 15 the prediction is right on, and bear number 23 was just under six inches.